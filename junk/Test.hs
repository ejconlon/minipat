...
-- TODO Use these as the basis of some unit tests
...
--   , disposeSt
--   )
-- import Minipat.Dirt.Logger (newLogger)
...
--
-- withSt :: (St DirtEnv -> IO a) -> IO a
-- withSt f = do
--   logger <- newLogger
--   bracket (initSt logger (defaultEnv defaultDirtEnv)) disposeSt f
--
