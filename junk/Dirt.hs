...
--  where
--   nul = Play (PlayTime 0 0 0) Map.empty
--   req = Set.fromList ["cps", "cycle", "delta"]
--   sets = \case
--     "cps" -> [DatumField (gconstructor @"DatumFloat") (gafield @"playTime" % gafield @"ptCps")]
--     "cycle" -> [DatumField (gconstructor @"DatumFloat") (gafield @"playTime" % gafield @"ptCycle")]
--     "delta" -> [DatumField (gconstructor @"DatumFloat") (gafield @"playTime" % gafield @"ptDelta")]
--     k -> [DatumField (prism' id Just) (gafield @"playData" % ix k)]
--
-- playS :: Serde () Play
